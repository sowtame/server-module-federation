...
import { RenderAndExtractContextFunction, RenderAndExtractContextResult } from './renderAndExtractContext'
...
export default async function serverRender(req, res, next) {
  ...
  const renderAndExtractContext = entrypoint['renderAndExtractContext'] as RenderAndExtractContextFunction
